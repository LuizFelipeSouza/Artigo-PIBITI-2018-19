...
Nesta subseção, serão descritas as funcionalidades das 11 tarefas de NLP encontradas no levantamento.
...
\textbf{Tradutor}: Ferramentas de tradução, transposição entre idiomas.\\
    \begin{figure}[ht]
        \centering
        \includegraphics[scale=0.5]{imagens/tradutor.jpg}
...
\textbf{Moderação de conteúdo}: Softwares para detecção de conteúdo imprópria em imagens, tais como nudez e violência. \\
